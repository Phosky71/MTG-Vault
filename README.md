...
### Your offline Magic: The Gathering collection manager

**An offline-first, multilingual Progressive Web App to organize, track, and analyze your MTG card collection — installable on any device, no internet required after first load.**

[![JavaScript](https://img.shields.io/badge/JavaScript-F7DF1E?style=flat&logo=javascript&logoColor=black)](https://developer.mozilla.org/en-US/docs/Web/JavaScript)
[![CSS](https://img.shields.io/badge/CSS-55,2%25-blue)](https://developer.mozilla.org/en-US/docs/Web/CSS)
...
| Dashboard | Collection | Deck Builder |
|:---------:|:----------:|:------------:|
| ![Dashboard](https://placehold.co/340x200/1a1a2e/e0e0e0?text=Dashboard+%26+Stats) | ![Collection](https://placehold.co/340x200/16213e/e0e0e0?text=Collection+Manager) | ![Deck Builder](https://placehold.co/340x200/0f3460/e0e0e0?text=Deck+Builder) |

| Card Search | Wishlist |
|:-----------:|:--------:|
| ![Search](https://placehold.co/340x200/533483/e0e0e0?text=Card+Search) | ![Wishlist](https://placehold.co/340x200/2b2d42/e0e0e0?text=Wishlist) |

</div>

> **Note:** Replace the placeholder images above with actual screenshots of the application.
